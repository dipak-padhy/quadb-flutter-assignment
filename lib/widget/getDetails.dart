                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ReadMoreText(
                      target,
                      style:
                          const TextStyle(fontSize: 16, fontFamily: 'Satoshi'),
                  ...
                  const Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("Recommended",
                            style:
                                TextStyle(fontSize: 16, fontFamily: 'Satoshi')),
                        Text("See All",
                            style: TextStyle(
                                fontSize: 16,
                                fontFamily: 'Satoshi',
                        ...
                        children: [
                          ...
                          widget.genres.length > 1
                              ...
                              : Container(
                                  ...
                                  /* height: 38,
                              width: 116,*/
                                  child: Text(widget.genres[0][0].toString(),
                                      style: const TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'Satoshi',
                                      )),
